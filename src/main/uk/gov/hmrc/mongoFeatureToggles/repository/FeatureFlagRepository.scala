...
package uk.gov.hmrc.mongoFeatureToggles.repository
...
import uk.gov.hmrc.mongoFeatureToggles.model.{FeatureFlag, FeatureFlagMongoFormats, FeatureFlagName}
...
class FeatureFlagRepository @Inject() (
  ...
  ec: ExecutionContext
      ...
      extraCodecs = Codecs.playFormatCodec(FeatureFlagMongoFormats.formats)
    )
    with Transactions {
