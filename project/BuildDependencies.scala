...
private object BuildDependencies {
  ...
  private val bootstrapVersion29 = "8.2.0"

  private val playVersion30 = "play-30"
  private val bootstrapVersion30 = "8.2.0"
  ...
  val compile28: Seq[ModuleID] = Seq(caffeine,
    ...
    "uk.gov.hmrc"            %% s"internal-auth-client-$playVersion28" % "1.9.0",
  ...
  val compile29: Seq[ModuleID] = Seq(caffeine,
    ...
    "uk.gov.hmrc" %% s"internal-auth-client-$playVersion29" % "1.9.0",
    "org.scala-lang.modules" %% "scala-collection-compat" % "2.11.0"
  )
  ...
  val compile30: Seq[ModuleID] = Seq(caffeine,
    ...
    "uk.gov.hmrc" %% s"internal-auth-client-$playVersion30" % "1.9.0",
    "org.scala-lang.modules" %% "scala-collection-compat" % "2.11.0"
  )
